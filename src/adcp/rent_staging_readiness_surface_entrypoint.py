"""Strict source-attesting bootstrap for the Rent staging readiness reader."""
...
SCHEMA_VERSION = 1
_EXPECTED_ENTRYPOINT_RELATIVE = Path("src/adcp/rent_staging_readiness_surface_entrypoint.py")
_EXPECTED_IMPLEMENTATION_RELATIVE = Path("src/adcp/rent_staging_readiness_surface.py")
...
def _unknown_result(
    ...
    *,
    ...
    roles = {
        ...
        for role in (
            "propertyai_rent_staging_migrator",
    ...
    refs = {
        ...
        for name in ("flyway-secret.conf", "web.dsn", "session.dsn", "worker.dsn")
    }
    return {
        ...
        "service_label": "com.propertyai.postgresql-rent-staging",
        "service_state": "UNKNOWN",
        "service_pid": "UNKNOWN",
        "postgres_version": "UNKNOWN",
        "database_identity": "UNKNOWN",
        "database_target_match": "UNKNOWN",
        "migration_history_class": "UNKNOWN",
        "flyway_history_rows": "UNKNOWN",
        "user_table_count": "UNKNOWN",
        "business_schema_count": "UNKNOWN",
        "real_rent_business_rows": "UNKNOWN",
        "fixture_rows": "UNKNOWN",
        "synthetic_financial_rows": "UNKNOWN",
        "role_facts": roles,
        "secret_reference_semantics": refs,
...
def _load_intended_module(source_root: Path) -> ModuleType:
    expected = source_root / "adcp" / "rent_staging_readiness_surface.py"
    ...
    spec = importlib.util.spec_from_file_location(
        "adcp.rent_staging_readiness_surface", resolved_expected
    )
